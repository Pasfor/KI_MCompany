...
public class Rnd_SmartClassic_SmartRoot extends Player {
    ...
    public Rnd_SmartClassic_SmartRoot(int pN, Player otherPlayer) {
...
//        }
    ...
    private void expand(GameState toExpand) {
        ...
        toExpand.childes = Expansion.rndExpandrndOneSmartRoot(toExpand, toExpand.steps, toExpand.getLvl() , toExpand.depth);
        //for all expansion

...
public class SmartExpansion_SmartRoot extends Player {
    ...
    public SmartExpansion_SmartRoot(int pN, Player otherPlayer) {
...
//        }
    ...
    private void expand(GameState toExpand) {
        ...
        toExpand.childes = Expansion.smartExpansionSmartRoot(toExpand, toExpand.steps, toExpand.getLvl() , toExpand.depth);
        //for all expansion

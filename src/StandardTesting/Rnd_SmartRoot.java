...
public class Rnd_SmartRoot extends Player {
    ...
    public Rnd_SmartRoot(int pN, Player otherPlayer) {
...
//        }
    ...
    private void expand(GameState toExpand) {
        ...
        toExpand.childes = Expansion.rndExpandSmartRoot(toExpand, toExpand.steps, toExpand.getLvl() , toExpand.depth);
        //for all expansion

...
public class Classic_Expansion_SmartRoot extends Player {
    ...
    public Classic_Expansion_SmartRoot(int pN, Player otherPlayer) {
...
//        }
    ...
    private void expand(GameState toExpand) {
        ...
        toExpand.childes = Expansion.classicExpansionSmartRoot(toExpand, toExpand.steps, toExpand.getLvl() , toExpand.depth);
        //for all expansion

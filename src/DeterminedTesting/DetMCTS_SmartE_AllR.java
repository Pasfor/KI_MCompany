...
public class DetMCTS_SmartE_AllR extends Player {
    ...
    public DetMCTS_SmartE_AllR (int pN, Player otherPlayer) {
    ...
    public void expand(GameState toExpand) {
        ...
        toExpand.childes = Expansion.determinedSmartAllRoot(toExpand, toExpand.steps, toExpand.getLvl() , toExpand.depth);
        //for all expansionkK
